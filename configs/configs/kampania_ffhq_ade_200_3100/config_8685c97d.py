...
from configs.configs.kampania_ffhq_ade_200_3100 import default_lbm_ffhq_128_config as default_config
...
def get_config():
    ...
    config.turbulence.turb_intensity = conf_utils.lin_schedule(0.0001, 0.0001, 3100, dtype=np.float32)
