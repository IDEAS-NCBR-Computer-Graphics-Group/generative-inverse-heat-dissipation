...
def main():
    ...
    param_grid = {
        ...
        'turbulence.turb_intensity' : [lin_schedule(0, 0, 3100, dtype=np.float32), lin_schedule(1e-4, 1e-4, 3100, dtype=np.float32), lin_schedule(1e-3, 1e-3, 3100, dtype=np.float32), lin_schedule(1E-6, 5E-4, 3100, dtype=np.float32)],
        'solver.cs2' : [1./3.]
