...
from numerical_solvers.solvers.img_reader import read_img_in_grayscale, normalize_grayscale_image_range, make_grayscale
...
def run_corruption(config):
    ...
    plt.imshow(np_gray_image, cmap='gray')
    plt.colorbar()
    plt.title(f'image')
    plt.show()
